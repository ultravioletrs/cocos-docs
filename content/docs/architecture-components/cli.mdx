...
For attestation policy examples, see the [On-Premises Attestation Verification](/trusted-execution/attestation/verification/on-premises-attestation-verification) documentation.
