...
For more information on Manager, please refer to [Manager docs](/architecture-components/manager).
...
For more information on Agent, please refer to [Agent docs](/architecture-components/agent).
...
For more information on CLI, please refer to [CLI docs](/architecture-components/cli).
