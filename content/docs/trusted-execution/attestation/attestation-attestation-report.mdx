---
title: Attestation Attestation Report
---

The attestation report contains information on the Confidential Virtual Machine (CVM) software, firmware, and the hardware that the CVM is running on. The report is either fetched by the Agent and sent to the CLI or used in attested TLS.
