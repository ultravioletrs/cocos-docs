---
title: Attestation Introduction
---
...
The primary mechanism for establishing this trust is **Attested TLS (aTLS)**. In this model, the CLI and Agent establish a TLS 1.3 session that is cryptographically bound to the TEE hardware, ensuring that the confidential channel is anchored in a hardware-root-of-trust.
