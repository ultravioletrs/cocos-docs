...
<!--
    Ovo isto nije istina za sve slucajeve. Ovo vazi za HAL, kod GCP i Azure dobijas vec gotovo
-->
To enable vTPM on AMD SEV-SNP CPUs we use firmware from [COCONUT Secure VM Service Module](https://github.com/coconut-svsm/svsm).
